...
export default function Guess({guess, answer}) {
  const fields = ["icon", "name", "gender", "region", "weapon", "affiliation", "age"];
  return (
    ...
    // If equal, displayVal remains unchanged
        ...
        const checkKeywords = ["blade","thors","class vii", "fools", "bracer guild","orbal","gun","bow","magic","jaeger","N/A", "halberd"];
        const checkBuffs = 
